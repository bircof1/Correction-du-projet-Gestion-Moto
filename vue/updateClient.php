      ...
      <div class="global-content">
        ...
        <button type="button" class="deconnect"> <a href="../index.php">Se deconnecter</a> </button>
          ...
          <div class="global-page">
                   ...
                   <div class="c-table">
                       <div class="sms">FORMULAIRE DE MODIFICATION CLIENTS</div>
                       ...
                       <form method="post" action="" enctype="multipart/form-data"> 
                            ...
                            <div class="row">
                              ...
                              <div class="col">
                                <input type="text" class="form-control" name="nom" value="<?= $valuer->getNom()?>" required ="required">
                              </div>
                              <div class="col">
                                <input type="text" class="form-control" name="prenom" value="<?= $valuer->getPrenom()?>" required ="required">
                            </div>
                            </div><br>
                            <div class="row">
                              <div class="col">
                                <input type="text" class="form-control" name="cnib" value="<?= $valuer->getCnib()?>" required ="required">
                              </div>
