                   ...
                   <div class="c-table">
                       ...
                       <form method="post" action="" enctype="multipart/form-data"> 
                            ...
                            <div class="row">
                              ...
                              <div class="col">
                                <input type="text" class="form-control" name="model" value="<?= $valuer->getModel()?>" required ="required">
                            </div>
                            </div><br>
                            <div class="row">
                              <div class="col">
                              ...
                              <div class="col">
                                <input type="text" class="form-control" name="cathegorie"  value="<?= $valuer->getCathegorie()?>" required ="required">
                              </div>
                            </div><br>
                            <div class="row">
                              <div class="col">
                                <input type="text" class="form-control" name="numero_seri" value="<?= $valuer->getNumero_seri()?>" required ="required">
                              </div>
                              <div class="col">
